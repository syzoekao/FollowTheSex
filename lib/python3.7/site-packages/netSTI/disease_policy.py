...
def create_tracker_and_outcome_vectors(Npop, time_horizon): 
	...
	return S0, I0, T0, last_test0, person_time0, n_notification0, n_name_trace0, n_infection0, n_intervention0, \
		out_S0, out_I0, out_T0, out_newI0, out_ext_seed0, out_nDeliver0, out_nContactTrace0, out_nNotified0, out_nTrueTreat0, \
...
def implement_strategy(ID, rel_hist, Npop, time_horizon, unit_per_year, seed_ix, \
	...
	out_S, out_I, out_T, out_newI, out_ext_seed, out_nDeliver, out_nContactTrace, out_nNotified, out_nTrueTreat, \
	...
	for t in range(0, time_horizon):  
		...
		if strategy == "tracing": 
			...
			tmp_name, tmp_count = notify_contact_deliver_sex_part(rel_hist, tmp_screen_I, \
		...
		if strategy == "EPT": 			
			deliver_name, deliver_count = notify_contact_deliver_sex_part(rel_hist, tmp_screen_I, \
		...
		if strategy == "PN": 
			...
			notify_name, tmp_count = notify_contact_deliver_sex_part(rel_hist, tmp_screen_I, pContact_PN, \
				unit_per_year, t)
