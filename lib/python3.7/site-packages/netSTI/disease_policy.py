...
def notify_contact_deliver_sex_part(el, tmp_screen_I, pContact, unit_per_year, infID, t, alpha = 1.0): 
	...
	n_infPart = part6mon[np.in1d(part6mon, infID)].shape[0] - tmp_screen_I.shape[0]
	n_part6mon = part6mon.shape[0] - tmp_screen_I.shape[0]
	...
	for t in range(0, time_horizon):  
		...
		if strategy == "PN": 
			if t >= 1: 
				...
				dum = (t - last_test[notify_test_name]) >= (unit_per_year / 2)
